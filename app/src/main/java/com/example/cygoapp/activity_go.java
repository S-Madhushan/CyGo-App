...
import com.example.cygoapp.components.GetRideSpinner;
...
public class activity_go extends AppCompatActivity {
    ...
    private void initGetRideLayoutElements() {
        ...
        spinnerAdapter = ArrayAdapter.createFromResource(activity_go.this, R.array.getRideSpinnerItems,
                android.R.layout.simple_spinner_item);
        spinnerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sortListSpinner.setAdapter(new GetRideSpinner(spinnerAdapter, R.layout.spinner_title_get_ride, activity_go.this));

        //sets arrayLists to adapter
        getRideAdapter = new GetRideAdapter(activity_go.this, rideUserArrayList);
        rideListView.setAdapter(getRideAdapter);

        //setting placeholder time in edit texts
//        startPointEditText.setText("Kandy");
    ...
    private void initGetRideButtons()
    {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity_go.this,activity_home.class);
        ...
        searchRideButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try
                {
                    ...
                    showProgressDialog(activity_go.this);
                    Constant.hideKeyboard(activity_go.this);
                    ...
                    else
                    {
                        ...
                        Toast.makeText(activity_go.this, getString(R.string.getride_check_dates_and_time), Toast.LENGTH_LONG).show();
                    }
                }
                catch (Exception e)
                {
        ...
        startDateEditText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(activity_go.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        estStartTimeEditText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(activity_go.this, AlertDialog.THEME_HOLO_LIGHT, new TimePickerDialog.OnTimeSetListener() {
                    @Override
